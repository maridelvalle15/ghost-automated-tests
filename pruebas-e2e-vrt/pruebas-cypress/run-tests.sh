...
# F01
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F01_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F01_testing.spec.js
...
# F03
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F03_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F03_testing.spec.js
...
# F04
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F04_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F04_testing.spec.js
...
# F05
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F05_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F05_testing.spec.js
...
# F06
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F06_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F06_testing.spec.js
...
# F07
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F07_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F07_testing.spec.js
...
# F10
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2368,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=reference,VRT=true --spec cypress/integration/examples/ghost_F10_testing.spec.js
...
node_modules/cypress/bin/cypress run --env GHOST_URL=http://localhost:2369,EMAIL=marisela.delvalle93@gmail.com,PASSWORD=12345678910,GHOST_VERSION=test,VRT=true --spec cypress/integration/examples/ghost_F10_testing.spec.js
